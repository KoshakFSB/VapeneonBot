...
BLOCK_TARIFFS = {
    "mute_1d":  {"kind": "mute", "price": 15.0,  "label": "Мут — 1 день"},
    "mute_2d":  {"kind": "mute", "price": 27.0,  "label": "Мут — 2 дня"},
    "mute_3d":  {"kind": "mute", "price": 41.0,  "label": "Мут — 3 дня"},
    "mute_7d":  {"kind": "mute", "price": 95.0,  "label": "Мут — неделя"},
    "ban_30d":  {"kind": "ban",  "price": 150.0, "label": "Бан — 30 дней"},
    "ban_perm": {"kind": "ban",  "price": 275.0, "label": "Бан — навсегда"},
    "warn_1":   {"kind": "warn", "price": 8.0,   "label": "Снятие 1 варна"},
}
