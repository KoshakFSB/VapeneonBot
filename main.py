...
async def cmd_clear_chat(message: Message):
    ...
    try:
        deleted_count = 0
        skipped_count = 0
        max_messages = 5000  # Ограничение для безопасности
        ...
        # Начинаем с последнего сообщения и идем назад
        current_message_id = message.message_id - 1
        
        while current_message_id > 0 and deleted_count + skipped_count < max_messages:
            try:
