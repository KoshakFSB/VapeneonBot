...
TERMS_OF_SERVICE_TEXT = (
    ...
    "сторонами в рамках сделки должны осуществляться <b>исключительно в чате, созданном ботом для "
    ...
    "━━━━━━━━━━━━━━━━━━━━━━\n"
    "2.1. Для корректного функционирования системы безопасных сделок у каждого участника должна "
    "быть <b>включена функция «История чата» (видимость предыдущих сообщений для новых участников)</b> "
    "в настройках Telegram-аккаунта.\n\n"
    "2.2. Если на момент возникновения спора или обращения в администрацию у любой из сторон "
    ...
    "2.4. Стороны обязаны самостоятельно убедиться во включённой истории чата <b>до начала "
...
async def safe_deal_create_redirect(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.edit_text(
        TERMS_OF_SERVICE_TEXT + "\n\n"
        "Нажмите <b>«Принимаю и продолжаю»</b>, чтобы приступить к созданию сделки.",
        reply_markup=keyboard.as_markup(),
        parse_mode="HTML"
    )
